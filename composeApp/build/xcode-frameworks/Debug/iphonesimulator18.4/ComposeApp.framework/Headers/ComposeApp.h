...
- (instancetype)initWithIsAuthenticated:(BOOL)isAuthenticated isLoading:(BOOL)isLoading error:(NSString * _Nullable)error user:(ComposeAppUser * _Nullable)user __attribute__((swift_name("init(isAuthenticated:isLoading:error:user:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppAuthState *)doCopyIsAuthenticated:(BOOL)isAuthenticated isLoading:(BOOL)isLoading error:(NSString * _Nullable)error user:(ComposeAppUser * _Nullable)user __attribute__((swift_name("doCopy(isAuthenticated:isLoading:error:user:)")));
...
@property (readonly) ComposeAppUser * _Nullable user __attribute__((swift_name("user")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OnboardingState")))
@interface ComposeAppOnboardingState : ComposeAppBase
- (instancetype)initWithCurrentPage:(int32_t)currentPage isCompleted:(BOOL)isCompleted __attribute__((swift_name("init(currentPage:isCompleted:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppOnboardingState *)doCopyCurrentPage:(int32_t)currentPage isCompleted:(BOOL)isCompleted __attribute__((swift_name("doCopy(currentPage:isCompleted:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithId:(NSString *)id email:(NSString *)email fullName:(NSString *)fullName __attribute__((swift_name("init(id:email:fullName:)"))) __attribute__((objc_designated_initializer));
- (ComposeAppUser *)doCopyId:(NSString *)id email:(NSString *)email fullName:(NSString *)fullName __attribute__((swift_name("doCopy(id:email:fullName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (class, readonly) ComposeAppScreen *onboarding __attribute__((swift_name("onboarding")));
@property (class, readonly) ComposeAppScreen *login __attribute__((swift_name("login")));
@property (class, readonly) ComposeAppScreen *createAccount __attribute__((swift_name("createAccount")));
@property (class, readonly) ComposeAppScreen *payment __attribute__((swift_name("payment")));
@property (class, readonly) ComposeAppScreen *healthProfile __attribute__((swift_name("healthProfile")));
@property (class, readonly) ComposeAppScreen *sampleCollection __attribute__((swift_name("sampleCollection")));
@property (class, readonly) ComposeAppScreen *scheduleBloodTest __attribute__((swift_name("scheduleBloodTest")));
...
@interface ComposeAppAuthViewModel : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)createAccountEmail:(NSString *)email password:(NSString *)password fullName:(NSString *)fullName completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("createAccount(email:password:fullName:completionHandler:)")));
...
- (void)sampleCollectionValidated __attribute__((swift_name("sampleCollectionValidated()")));
- (void)setAuthenticatedIsAuthenticated:(BOOL)isAuthenticated __attribute__((swift_name("setAuthenticated(isAuthenticated:)")));
@property (readonly) id<ComposeAppKotlinx_coroutines_coreStateFlow> sampleCollectionState __attribute__((swift_name("sampleCollectionState")));
@property (readonly) id<ComposeAppKotlinx_coroutines_coreStateFlow> state __attribute__((swift_name("state")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OnboardingViewModel")))
@interface ComposeAppOnboardingViewModel : ComposeAppBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSString *)getCurrentPageTitle __attribute__((swift_name("getCurrentPageTitle()")));
- (int32_t)getTotalPages __attribute__((swift_name("getTotalPages()")));
- (void)nextPage __attribute__((swift_name("nextPage()")));
- (void)previousPage __attribute__((swift_name("previousPage()")));
- (void)skipOnboarding __attribute__((swift_name("skipOnboarding()")));
@property (readonly) id<ComposeAppKotlinx_coroutines_coreStateFlow> state __attribute__((swift_name("state")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppColors")))
@interface ComposeAppAppColors : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)appColors __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppAppColors *shared __attribute__((swift_name("shared")));
@property (readonly) uint64_t BackgroundDark __attribute__((swift_name("BackgroundDark")));
@property (readonly) uint64_t Black __attribute__((swift_name("Black")));
@property (readonly) uint64_t BorderLineColor __attribute__((swift_name("BorderLineColor")));
@property (readonly) uint64_t CardBackground __attribute__((swift_name("CardBackground")));
@property (readonly) uint64_t PurpleBackground __attribute__((swift_name("PurpleBackground")));
@property (readonly) uint64_t PurpleButtonBackground __attribute__((swift_name("PurpleButtonBackground")));
@property (readonly) uint64_t PurpleCardBackground __attribute__((swift_name("PurpleCardBackground")));
@property (readonly) uint64_t PurpleIconBackground __attribute__((swift_name("PurpleIconBackground")));
@property (readonly) uint64_t SurfaceDark __attribute__((swift_name("SurfaceDark")));
@property (readonly) uint64_t TextGrey __attribute__((swift_name("TextGrey")));
@property (readonly) uint64_t TextPrimary __attribute__((swift_name("TextPrimary")));
@property (readonly) uint64_t Transparent __attribute__((swift_name("Transparent")));
@property (readonly) uint64_t White __attribute__((swift_name("White")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppDimens")))
@interface ComposeAppAppDimens : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)appDimens __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppAppDimens *shared __attribute__((swift_name("shared")));
@property (readonly) float buttonCornerRadius __attribute__((swift_name("buttonCornerRadius")));
@property (readonly) float buttonHeight __attribute__((swift_name("buttonHeight")));
@property (readonly) float buttonMargin __attribute__((swift_name("buttonMargin")));
@property (readonly) float cardCornerRadius __attribute__((swift_name("cardCornerRadius")));
@property (readonly) float cardPadding __attribute__((swift_name("cardPadding")));
@property (readonly) float iconSizeMd __attribute__((swift_name("iconSizeMd")));
@property (readonly) float paddingValues __attribute__((swift_name("paddingValues")));
@property (readonly) float spacingLg __attribute__((swift_name("spacingLg")));
@property (readonly) float spacingMd __attribute__((swift_name("spacingMd")));
@property (readonly) float spacingXl __attribute__((swift_name("spacingXl")));
@property (readonly) int64_t textSizeMd __attribute__((swift_name("textSizeMd")));
@property (readonly) int64_t textSizeMedium __attribute__((swift_name("textSizeMedium")));
@property (readonly) int64_t textSizeTitle __attribute__((swift_name("textSizeTitle")));
@property (readonly) int64_t textSizeXl __attribute__((swift_name("textSizeXl")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppFonts")))
@interface ComposeAppAppFonts : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)appFonts __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppAppFonts *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppGradients")))
@interface ComposeAppAppGradients : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)appGradients __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppAppGradients *shared __attribute__((swift_name("shared")));
@property (readonly) ComposeAppUi_graphicsBrush *diagonalBackgroundGradient __attribute__((swift_name("diagonalBackgroundGradient")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Dimens")))
@interface ComposeAppDimens : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)dimens __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppDimens *shared __attribute__((swift_name("shared")));
@property (readonly) float dp_0 __attribute__((swift_name("dp_0")));
@property (readonly) float dp_1 __attribute__((swift_name("dp_1")));
@property (readonly) float dp_10 __attribute__((swift_name("dp_10")));
@property (readonly) float dp_100 __attribute__((swift_name("dp_100")));
@property (readonly) float dp_12 __attribute__((swift_name("dp_12")));
@property (readonly) float dp_120 __attribute__((swift_name("dp_120")));
@property (readonly) float dp_14 __attribute__((swift_name("dp_14")));
@property (readonly) float dp_16 __attribute__((swift_name("dp_16")));
@property (readonly) float dp_160 __attribute__((swift_name("dp_160")));
@property (readonly) float dp_18 __attribute__((swift_name("dp_18")));
@property (readonly) float dp_2 __attribute__((swift_name("dp_2")));
@property (readonly) float dp_20 __attribute__((swift_name("dp_20")));
@property (readonly) float dp_200 __attribute__((swift_name("dp_200")));
@property (readonly) float dp_24 __attribute__((swift_name("dp_24")));
@property (readonly) float dp_28 __attribute__((swift_name("dp_28")));
@property (readonly) float dp_300 __attribute__((swift_name("dp_300")));
@property (readonly) float dp_32 __attribute__((swift_name("dp_32")));
@property (readonly) float dp_4 __attribute__((swift_name("dp_4")));
@property (readonly) float dp_40 __attribute__((swift_name("dp_40")));
@property (readonly) float dp_48 __attribute__((swift_name("dp_48")));
@property (readonly) float dp_50 __attribute__((swift_name("dp_50")));
@property (readonly) float dp_56 __attribute__((swift_name("dp_56")));
@property (readonly) float dp_64 __attribute__((swift_name("dp_64")));
@property (readonly) float dp_72 __attribute__((swift_name("dp_72")));
@property (readonly) float dp_8 __attribute__((swift_name("dp_8")));
@property (readonly) float dp_80 __attribute__((swift_name("dp_80")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TextSizes")))
@interface ComposeAppTextSizes : ComposeAppBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)textSizes __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) ComposeAppTextSizes *shared __attribute__((swift_name("shared")));
@property (readonly) int64_t sp_10 __attribute__((swift_name("sp_10")));
@property (readonly) int64_t sp_12 __attribute__((swift_name("sp_12")));
@property (readonly) int64_t sp_14 __attribute__((swift_name("sp_14")));
@property (readonly) int64_t sp_16 __attribute__((swift_name("sp_16")));
@property (readonly) int64_t sp_20 __attribute__((swift_name("sp_20")));
@property (readonly) int64_t sp_24 __attribute__((swift_name("sp_24")));
@property (readonly) int64_t sp_28 __attribute__((swift_name("sp_28")));
@property (readonly) int64_t sp_32 __attribute__((swift_name("sp_32")));
@property (readonly) int64_t sp_36 __attribute__((swift_name("sp_36")));
@property (readonly) int64_t sp_48 __attribute__((swift_name("sp_48")));
@property (readonly) int64_t sp_60 __attribute__((swift_name("sp_60")));
@property (readonly) int64_t sp_72 __attribute__((swift_name("sp_72")));
@property (readonly) int64_t sp_90 __attribute__((swift_name("sp_90")));
@end
